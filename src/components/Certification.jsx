...
const Certification = () => {
  ...
  <div className="text-center mb-12">
    ...
    <p className="text-gray-600">Committed to success through quality and trust.</p>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-center mb-12 px-24">
    ...
    <div className="px-8">
      ...
      <p className=" mt-2">Every product meets stringent pharmaceutical standards</p>
    </div>

    {/* Card 2 */}
    <div className="px-8">
      <img src={Innovation} alt="Innovation" className="mx-auto mb-4 h-12" />
      <h3 className="text-[24px ] font-medium">Innovation Focus</h3>
      <p className=" mt-2">Continuous R&amp;D investment in cutting-edge technology</p>
    </div>
    ...
    <div className="px-8">
      ...
      <p className=" mt-2">24/7 support and comprehensive service programs</p>
    </div>
  </div>
  ...
  <p className="font-medium text-center">ISO 9001:2015 Quality Management</p>
</div>
